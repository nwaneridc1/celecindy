...
const About = () => {
  ...
  return (
    <div>
      <div className="pt-6 pb-6 overflow-hidden">
                    ...
                    >
                      ...
                      <div className="flex flex-col gap-3 text-center items-center">
                        ...
                        <div className="grid grid-cols-2 pb-5 gap-5">
                          ...
                          <div className="group flex items-center gap-3 bg-gray-200 p-3 rounded-lg shadow-md hover:shadow-xl transition">
                            <div className="w-8 h-8 flex items-center justify-center rounded-full bg-gradient-to-r from-pink-500 to-purple-600">
                              <Icon
                                size={18}
                            ...
                            <a
                              ...
                              target="_blank"
                              rel="noreferrer"
                              className="text-gray-800 text-lg font-semibold group-hover:text-pink-600 transition"
                            >
                              Instagram
                            </a>
                          </div>
